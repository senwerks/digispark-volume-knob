...
Print the 3 STLs in the repository: [Chassis v1.stl](https://github.com/senwerks/digispark-volume-knob/blob/master/Chassis v1.stl), [Knob v1.stl](https://github.com/senwerks/digispark-volume-knob/blob/master/Knob v1.stl) (unless you're using the knob that came with the encoder, but I preferred my minimal design) and [Lid v1.stl](https://github.com/senwerks/digispark-volume-knob/blob/master/Lid v1.stl).
...
![Digispark Volume Knob parts](https://github.com/senwerks/digispark-volume-knob/blob/master/Meta/DigisparkVolumeKnob-Parts.jpg)

![Digispark Volume Knob assembly](https://github.com/senwerks/digispark-volume-knob/blob/master/Meta/DigisparkVolumeKnob-Assembly.jpg)
...
![Digispark Volume Knob on a laptop](https://github.com/senwerks/digispark-volume-knob/blob/master/Meta/DigisparkVolumeKnob-Laptop.jpg)

![Digispark Volume Knob on a PC](https://github.com/senwerks/digispark-volume-knob/blob/master/Meta/DigisparkVolumeKnob-Dekstop.jpg)
